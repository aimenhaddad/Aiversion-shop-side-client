                                ...
                                <input name="id" type="hidden" value="<?php echo $id?>"/> 
                                   ...
                                   <div class="form-group mb-2">
                                    <label class="col-md-4 control-label">Phone</label>
                                      <div class=" inputGroupContainer">
                                         <div class="input-group-prepend"><input id="phone" name="phone" placeholder="Phone" class="form-control" required="true" value="" type="text"></div>
                                      </div>
                                   </div>
                                   <div class="form-group mb-3">
                                    <label class="control-label">Quantity</label>
                                      <div class=" inputGroupContainer">
                                         <div class="input-group"><input id="quantity" name="quantity" placeholder="Quantity" class="form-control" required="true" value="" type="number"></div>
                                      </div>
                                   </div>
                                   <div class="form-group mb-3 ">
